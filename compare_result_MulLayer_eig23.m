...
% ArtificiallyChange5thDimCoefficients
...
% csv_predicted = 'C:\Users\kezhili\Documents\Python Scripts\data\eig_MulLayer_predicted_full23.csv';
% predicted = csvread(csv_predicted);
% csv_y_test = 'C:\Users\kezhili\Documents\Python Scripts\data\eig_MulLayer_y_test_full23.csv';
% y_test = csvread(csv_y_test);
csv_generated = 'C:\Users\kezhili\Documents\Python Scripts\data\eig_MulLayer_generated_full23-3.csv';
...
%         filename_gif = 'C:\Kezhi\MyCode!!!\Simulated_Worm\eig_1(23).gif';
%         
...
%         filename_gif = 'C:\Kezhi\MyCode!!!\Simulated_Worm\eig_2(23).gif';
%    elseif tt == 3
        eig_radias_vec = generated_ske(:,1:end-1);
        mean_angle_vec_diff = generated_ske(:,end);
        mean_angle_vec_diff(1) = mean_angle_vec_diff(1) + FirstAbsAng;
        mean_angle_vec_cur = cumsum(mean_angle_vec_diff);
        filename_gif = 'C:\Kezhi\MyCode!!!\Simulated_Worm\eig_3(23-3).gif';
%    end
