...
csv_predicted3 = 'C:\Users\kezhili\Documents\Python Scripts\data\predicted3(18-650-650-18).csv';
predicted3 = csvread(csv_predicted3);

%predicted_diff = [medfilt1(predicted3(:,end),3,50),predicted3(:,1:end-3)];

predicted3(1,end) = firstRow_angle_vec(size(angle_vec3,2)-size(predicted3,1)+1);
firstRow1 = cumsum(predicted3(:,end));
predicted_diff = [firstRow1,predicted3(:,1:end-3)];
...
csv_y_test3 = 'C:\Users\kezhili\Documents\Python Scripts\data\y_test3(18-650-650-18).csv';
y_test3 = csvread(csv_y_test3);

y_test3(1,end) = firstRow_angle_vec(size(angle_vec3,2)-size(predicted3,1)+1);
firstRow2 = cumsum(y_test3(:,end));
y_test_diff = [firstRow2(:,end),y_test3(:,1:end-3)];
...
csv_generated3 = 'C:\Users\kezhili\Documents\Python Scripts\data\generated3(18-650-650-18).csv';
generated_ske3 = csvread(csv_generated3);

generated_ske3(1,end) = firstRow_angle_vec(size(angle_vec3,2)-size(predicted3,1)+1);
firstRow3 = cumsum(generated_ske3(:,end));
generated_ske_diff = [firstRow3,generated_ske3(:,1:end-3)];
