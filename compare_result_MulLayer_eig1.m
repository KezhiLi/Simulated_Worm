...
csv_predicted = 'C:\Users\kezhili\Documents\Python Scripts\data\eig_MulLayer_predicted_full1.csv';
predicted = csvread(csv_predicted);
csv_y_test = 'C:\Users\kezhili\Documents\Python Scripts\data\eig_MulLayer_y_test_full1.csv';
y_test = csvread(csv_y_test);
csv_generated = 'C:\Users\kezhili\Documents\Python Scripts\data\eig_MulLayer_generated_full1.csv';
generated_ske = csvread(csv_generated);

load_path = 'C:\Users\kezhili\Documents\Python Scripts\data\';
eig_vec_file = 'eig_para_full1.hdf5';
