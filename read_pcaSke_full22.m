...
hdf5_file_name = 'Z:\Results\nas207-1\experimentBackup\from pc207-18\!worm_videos\copied from pc207-13\misc_videos\robyn dvd\AQ2316 on food L_2011_05_25__09_59_00___1___1_skeletons.hdf5';
masked_image_file =  'Z:\MaskedVideos\nas207-1\experimentBackup\from pc207-18\!worm_videos\copied from pc207-13\misc_videos\robyn dvd\AQ2316 on food L_2011_05_25__09_59_00___1___1.hdf5';
...
h5create([save_path,'eig_para_full22-AQ2316.hdf5'], '/eig_coef', size(eig_coef), 'Datatype', 'double', ...
    'Chunksize', size(eig_coef), 'Deflate', 5, 'Fletcher32', true, 'Shuffle', true)
h5write([save_path,'eig_para_full22-AQ2316.hdf5'], '/eig_coef', eig_coef);
h5create([save_path,'eig_para_full22-AQ2316.hdf5'], '/eig_vec', size(eig_vec), 'Datatype', 'double', ...
    'Chunksize', size(eig_vec), 'Deflate', 5, 'Fletcher32', true, 'Shuffle', true)
h5write([save_path,'eig_para_full22-AQ2316.hdf5'], '/eig_vec', eig_vec);
h5create([save_path,'eig_para_full22-AQ2316.hdf5'], '/len_vec', size(len_vec), 'Datatype', 'double', ...
    'Chunksize', size(len_vec), 'Deflate', 5, 'Fletcher32', true, 'Shuffle', true)
h5write([save_path,'eig_para_full22-AQ2316.hdf5'], '/len_vec', len_vec);
