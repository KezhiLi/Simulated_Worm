...
angle_vec2_ind = setdiff( 1:size(angle_vec2,2), find(isnan(sum(angle_vec2))==1));
angle_vec2_ful = angle_vec2(:,angle_vec2_ind);
...
% if exist([save_path,'angle_vec2_ful.hdf5'])>1
%     delete([save_path,'angle_vec2_ful.hdf5']);
% end
% h5create([save_path,'angle_vec2_ful.hdf5'], '/angle_vec2_ful', size(angle_vec2_ful), 'Datatype', 'double', ...
%     'Chunksize', size(angle_vec2_ful), 'Deflate', 5, 'Fletcher32', true, 'Shuffle', true)
% h5write([save_path,'angle_vec2_ful.hdf5'], '/angle_vec2_ful', angle_vec2_ful);
