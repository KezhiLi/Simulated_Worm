...
csv_predicted2 = 'C:\Users\kezhili\Documents\Python Scripts\data\predicted2.csv';
...
csv_y_test2 = 'C:\Users\kezhili\Documents\Python Scripts\data\y_test2.csv';
...
csv_generated2 = 'C:\Users\kezhili\Documents\Python Scripts\data\generated2.csv';
...
for tt = 3;
    if tt==1
        ...
        loc = predicted_loc;
        filename_gif = 'C:\Kezhi\MyCode!!!\Simulated_Worm\12.gif';
    elseif tt ==2
        radias_vec = y_test;
        loc = y_test_loc;
        filename_gif = 'C:\Kezhi\MyCode!!!\Simulated_Worm\22.gif';
    elseif tt == 3
        radias_vec = generated_ske;
        loc = generated_loc;
        filename_gif = 'C:\Kezhi\MyCode!!!\Simulated_Worm\32.gif';
    end
    ...
    for ii = 1: 100%size(pred_ske,3);
        %img = zeros(480,640);
        plot(pred_ske(1,:,ii),pred_ske(2,:,ii),'*-');
        axis equal
        axis([2500 3600 6300 6700])
        %pause(0.1)
