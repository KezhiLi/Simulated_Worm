...
if exist([save_path,'angle_vec3.hdf5'])>1
    delete([save_path,'angle_vec3.hdf5']);
end
h5create([save_path,'angle_vec3.hdf5'], '/angle_vec3', size(angle_vec3), 'Datatype', 'double', ...
    'Chunksize', size(angle_vec3), 'Deflate', 5, 'Fletcher32', true, 'Shuffle', true)
h5write([save_path,'angle_vec3.hdf5'], '/angle_vec3', angle_vec3);
