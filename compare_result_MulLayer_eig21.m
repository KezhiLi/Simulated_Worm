...
csv_predicted = 'C:\Users\kezhili\Documents\Python Scripts\data\eig_MulLayer_predicted_full21.csv';
predicted = csvread(csv_predicted);
csv_y_test = 'C:\Users\kezhili\Documents\Python Scripts\data\eig_MulLayer_y_test_full21.csv';
y_test = csvread(csv_y_test);
csv_generated = 'C:\Users\kezhili\Documents\Python Scripts\data\eig_MulLayer_generated_full21.csv';
generated_ske = csvread(csv_generated);

load_path = 'C:\Users\kezhili\Documents\Python Scripts\data\';
eig_vec_file = 'eig_para_full21.hdf5';
...
for tt = 3;
    if tt==1
        ...
        filename_gif = 'C:\Kezhi\MyCode!!!\Simulated_Worm\eig_1(21).gif';
    ...
    %    eig_radias_vec = icasig{n};
        ...
        filename_gif = 'C:\Kezhi\MyCode!!!\Simulated_Worm\eig_2(21).gif';
    elseif tt == 3
        eig_radias_vec = generated_ske(:,1:end-1);
        mean_angle_vec_diff = generated_ske(:,end);
        mean_angle_vec_diff(1) = mean_angle_vec_diff(1) + FirstAbsAng;
        mean_angle_vec_cur = cumsum(mean_angle_vec_diff);
        filename_gif = 'C:\Kezhi\MyCode!!!\Simulated_Worm\eig_3(21).gif';
    end
